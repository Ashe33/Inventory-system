...
<div class="table-card">
    ...
    <table>
        ...
        <?php if ($all_requests && $all_requests->num_rows > 0): ?>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="actions-col">
                        <a href="process/request_approve.php?id=<?= $r['id'] ?>" class="btn btn-green" onclick="return confirm('Approve this request?')">✅ Approve</a>
                        <a href="process/request_decline.php?id=<?= $r['id'] ?>" class="btn btn-red" onclick="return confirm('Decline this request?')">❌ Decline</a>
                    </div>
                    <?php else: ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <tr class="empty-row"><td colspan="9">No requests yet.</td></tr>
        <?php endif; ?>
        </tbody>
    </table>
</div>
